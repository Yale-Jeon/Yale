...
$select_query="select password from project.president where president_id = $id";
...
if (in_array($pw, $PW)) {
	...
	echo "<script language='javascript'>parent.location.replace('../main_presi.html');</script>";
}
else {
