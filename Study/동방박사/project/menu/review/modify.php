...
<?php
	...
	$bno = $_GET['idx'];
	$sql = mq("select * from review where idx='".$bno."'");
...
<body>
    <div id="board_write">
        <h1><a href="index.php">리뷰 수정하기</a></h1>
        <h4>글을 수정합니다</h4>
            <div id="write_area">
                <form action="modify_ok.php/<?php echo $board['idx']; ?>" method="post">
                    ...
                    <table align="center" style="width: 90%;" cellpadding="7" cellspacing="1" border="1">
                        <tr><td align="center" colspan="4"><h2>리뷰 수정</h2></td></tr>
                        <tr><td align="center" colspan="4">**리뷰는 작성자가 직접 입력한 이름으로 게시되나, 관리자는 작성자 정보를 보유합니다</td></tr>
                        <tr>
                            <td align="center" style="width: 10%;">제 목</td>
                            <td><input type="text" name="title" size="30" maxlength="45" placeholder="<?php echo "$board[title]";?>" required /></td>
                            <td align="center" style="width: 10%;">이 름</td>
                            <td><input type="text" name="name" size="30" placeholder="<?php echo "$board[name]";?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="3"><textarea name="text_review" rows="20" style="width: 99%;"><?php echo "$board[review]";?></textarea></td>
                        </tr>
