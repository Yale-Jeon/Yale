<html>
<body bgcolor="#FFFBF0">
<div style="margin-top: 50px; margin-left: 30px; font-size: 25px;"><b>동아리지원서 승인</b></div><br>
<div style="margin-left: 50px; margin-bottom: 5px;">동방박사 사이트에서 해당 동아리를 대상으로 작성된 동아리 지원서 승인창입니다.
체크박스를 통해 지원서를 승인해 주세요.</div><br>
<form method="post" action="admit_registration.php">
