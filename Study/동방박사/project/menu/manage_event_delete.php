...
<meta charset="utf-8">
<body bgcolor="#FFFBF0">
<div style="margin-top: 50px; margin-left: 50px; font-size: 25px;"><b>동아리 Activity 삭제</b></div><br>
<div style="margin-left: 50px;">동방박사 사이트에 게시되어 있는 해당 동아리의 활동 이벤트를 삭제하실 수 있습니다</div>
...
<table align="center" style="width: 90%;">
	...
	while ($db=mysqli_fetch_array($result_act)) {
		echo "<tr align='center'><td><input type='checkbox' name='choice[]' value='$db[info_num]'></td>";
		echo "<td>$db[month]</td>";
		echo "<td>$db[day]</td>";
		echo "<td>$db[time]</td>";
		echo "<td>$db[place]</td>";
	...
	?>
	<tr align="right">
		<td colspan="8"><input type="submit" style="width: 70px; height: 25px; background-color: #FFFBF0; border-color: #BF9000; border-width: 1px;" value="삭제"></td>
	</tr>
</table>
</form>
</html>